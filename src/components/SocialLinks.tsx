      ...
      {socials.map((social, index) => {
        ...
        return (
          ...
          >
            ...
            />
            <div className="relative p-2 md:p-3 bg-black/30 dark:bg-gray-800/30 backdrop-blur-md rounded-full border border-white/10 dark:border-white/20 transition-all duration-300 hover:scale-110">
              <Icon
              ...
              {!isMobile && (
                <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-black/80 dark:bg-gray-800/80 backdrop-blur-md px-2 py-1 rounded text-xs text-white dark:text-gray-200 opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
                  {social.label}
                </div>
              )}
            </div>
